...
class Solution(object):
    ...
    def rewrite2(self, data):
        ...
        for d in data:
            ...
            # match 前一個因為:
            # 0b11000000 == 0b11000000 時, 0b11100000 也會match.
            if d & 0b11000000 == 0b10000000:
                if not remain:  # 注意! 是 not remain, 因為到這裡必須要有remain
                    return False

                remain -= 1  # 因為是單獨的byte, 減1
                continue

            if d & 0b11100000 == 0b11000000:
                if remain:
                    return False
        ...
        return True if not remain else False


def build_input():
    return [1, 197, 130, 3, 197, 130]
    return [197, 130, 1] # 0b11000101 0b10000010 0b0000001
    return [197] # 0b11000101
    return [235, 140, 4]
    return [145]
