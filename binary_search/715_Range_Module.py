...
Your task is to design and implement the following interfaces in an efficient
manner.
...
should add any numbers in the interval [left, right)
...
class RangeModule(object):
    ...
    def addRange(self, left, right, track=True):
        def index(x):
            ...
            if self.X[i] != x:
                self.X.insert(i, x)
                #  print("track in: {}".format(self.track))
                #  print("i: {}".format(i))
