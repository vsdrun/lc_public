...
like 'git bisect'  https://git-scm.com/docs/git-bisect
...
class Solution(object):
    ...
    def rewrite(self, n):
        ...
        while left < right: # 含 right
            m = left + (right - left) / 2  # 永遠使用這個forumla

            if isBadVersion(m): # 右半邊
                right = m
            else: # 右半邊
                left = m + 1 # false, thus left is the true
...
if __name__ == "__main__":
    ...
    print(s.firstBadVersion2(build()))
