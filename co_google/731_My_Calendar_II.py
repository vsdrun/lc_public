...
if __name__ == "__main__":
    s = MyCalendarTwo()
    print(s.book(10, 20))  # true
    print(s.book(50, 60))  # true
    print(s.book(10, 40))  # true
    print(s.book(5, 15))  # false
    print(s.book(5, 10))  # true
    print(s.book(25, 55))  # true
