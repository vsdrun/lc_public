...
The given input is a directed graph that started as a
rooted tree with N nodes (with distinct values 1, 2, ..., N),
...
A loop, and there is one node who has 2 parents,
    that node must be inside the loop.
